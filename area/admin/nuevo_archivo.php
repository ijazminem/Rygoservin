...
?>
	...
	<section id="Breadcrumbs">
		<div class="breadcrumbs_contet">
			...
			<a class="active">Agregar Archivo</a>
		</div>
	</section>

	<!-- Form -->
	<section id="Content_Form">
		<form id="Form_Archivos" enctype="multipart">
			...
			<div class="f_item">
				...
				<input type="text" id="nombre" name="nombre" class="f_input_text">
			</div>

			<div class="f_item">
				<label>Descripción: <span>*</span></label>

				<textarea id="descripcion" name="descripcion" class="f_textarea" rows="5"></textarea>
			</div>

			<div class="f_item">
				<label>Archivo: <span>*</span></label>

				<input type="file" id="archivo" name="archivo" class="f_file">
			</div>

			<div class="f_item">
				<label>ID del proceso: <span>*</span></label>

				<input type="number" id="id_proceso" name="id_proceso" class="f_input_number readonly" readonly="readonly" value="<?php echo $Proceso->get_id_proceso(); ?>">
			</div>

			<!-- Botón -->
			<div class="f_btn">
				<input type="button" id="btn_agregar_archivo" class="f_input_btn" value="Crear Archivo">
